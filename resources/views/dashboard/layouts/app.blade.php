        ...
        <section class="content">
            ...
            <div class="row">
                            ...
                            <ul class="products-list product-list-in-box">
                                <li class="item">
                                    <div class="product-img">
                                        <img src="{{ asset('dashboard/images/default-50x50.gif')}}" alt="Product Image">
                                    </div>
                ...
                <div class="col-xl-4 col-lg-6 col-12">
                    ...
                    <div class="box box-widget widget-user-3">
                        ...
                        <div class="widget-user-header bg-purple"  style="background: url({{ asset('dashboard/images/photo1.png')}}) center center;">
                            <div class="info-user">
                            ...
                            <div class="widget-user-image clearfix">
                                <img class="rounded-circle" src="{{ asset('dashboard/images/user7-128x128.jpg')}}" alt="User Avatar">
                            </div>
                            <!-- /.widget-user-image -->
                        </div>
                        ...
                        <div class="box-body">
                            ...
                            <div class="direct-chat-messages" id="direct-chat">
                                ...
                                <div class="direct-chat-msg">
                                    ...
                                    <!-- /.direct-chat-info -->
                                    <img class="direct-chat-img" src="{{ asset('dashboard/images/user1-128x128.jpg')}}" alt="message user image">
                                    <!-- /.direct-chat-img -->
                                ...
                                <div class="direct-chat-msg right">
                                    ...
                                    <!-- /.direct-chat-info -->
                                    <img class="direct-chat-img" src="{{ asset('dashboard/images/user3-128x128.jpg')}}" alt="message user image">
                                    <!-- /.direct-chat-img -->
                                    <div class="direct-chat-text">
                                        Lorem Ipsum is...
                                    </div>
                            ...
                            <div class="direct-chat-contacts">
                                <ul class="contacts-list">
                                    <li>
                                        <a href="#">
                                            <img class="contacts-list-img" src="{{ asset('dashboard/images/user1-128x128.jpg')}}" alt="User Image">
							...
							<span class="contacts-list-name">
							  ...
							  <small class="contacts-list-date pull-right">April 14, 2017</small>
                                    ...
                                    <li>
                                        <a href="#">
                                            <img class="contacts-list-img" src="{{ asset('dashboard/images/user7-128x128.jpg')}}" alt="User Image">
            ...
            <div class="row">
                ...
                <div class="col-xl-5 col-12">
                    <div class="box">
                        <div class="card-body bg-img py-60" style="background-image: url({{ asset('dashboard/images/gallery/thumb/5.jpg')}})" data-overlay="5">
